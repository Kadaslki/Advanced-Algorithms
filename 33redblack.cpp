...

{
...

    {
        ...
        rbt.rbtree_insert(t, (void*)(intptr_t)x, (void*)(intptr_t)y, compare_int);

        assert(rbt.rbtree_lookup(t, (void*)(intptr_t)x, compare_int) == (void*)(intptr_t)y);
...

    {
        ...
        rbt.rbtree_delete(t, (void*)(intptr_t)x, compare_int);
